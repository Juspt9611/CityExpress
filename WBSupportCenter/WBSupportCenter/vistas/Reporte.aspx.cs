...
namespace WBSupportCenter.vistas
{
    public partial class Reporte : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string ObtenerDatos(string fechaInicial, string fechaFinal, string valReporte)
        {
            WSsupportCenterClass metodo = new WSsupportCenterClass();
            DataTable dtTitulo = new DataTable();
            dtTitulo = ConvertToDataTable(metodo.WSObtenerArticulo(fechaInicial, fechaFinal, valReporte));
